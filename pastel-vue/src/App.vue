   ...
   <v-card>
    <v-layout>
      ...
      >
        <v-list>
          <v-list-item
            prepend-avatar="https://github.com/pohadkove/Website/blob/main/img/pastelcss-logos.jpeg"
            title="pastel.css"
            subtitle=""
          ></v-list-item>
        </v-list>
      ...
      <div class="cont">
      <h1 id="btn">Buttons</h1>
      <h2>Normal</h2>
       <button class="d-primary-btn">Hello</button>
       <br>
       <a href="https://imgur.com/rf6s8RB"><img src="https://i.imgur.com/rf6s8RB.png" title="source: imgur.com" /></a>
       <br>
       <!---->
         
       <h2>pill</h2>
       <button class="d-primary-btn-pill">Hello</button>
       <br>
       <a href="https://imgur.com/P0ktrCT"><img src="https://i.imgur.com/P0ktrCT.png" title="source: imgur.com" /></a>
       <br>
              <!---->
       ...
       <h2>with ripple</h2>
       <button class="d-primary-btn ripple">Hello</button>
       <br>
       <a href="https://imgur.com/X4gxPnr"><img src="https://i.imgur.com/X4gxPnr.png" title="source: imgur.com" /></a>
       <br>
              <!---->
